...
RoomManager.prototype.deallocateRoom = function() {
	
}

RoomManager.prototype.allocateSlot = function() {

}

RoomManager.prototype.deallocateSlot = function() {
};
...
RoomManager.prototype.disconnectPlayer = function(socket) {
...
RoomManager.prototype.disconnectClient = function(socket) {
	...
	if (room !== undefined) {
		var otherSocketIds = Object.keys(room.takenSpots);
		for (var i = 0; i < otherSocketIds.length; ++i) {
			this.disconnectPlayer(this.namespace.sockets[otherSocketIds[i]]);
		}
		console.log("stop");
